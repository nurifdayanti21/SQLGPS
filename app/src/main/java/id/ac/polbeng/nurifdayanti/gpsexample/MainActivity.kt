package id.ac.polbeng.nurifdayanti.gpsexample
...
import id.ac.polbeng.nurifdayanti.gpsexample.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        task.addOnSuccessListener {
            locationRequest = LocationRequest.create().apply {
                ...
                // application will never receive updates more requently than this value.
